...
def lambda_handler(event, context):
    ...
    api_endpoint = os.environ.get('API_ENDPOINT_RELEASE_INVENTORY')
    
    if not api_endpoint:
        logger.error("API_ENDPOINT_RELEASE_INVENTORY environment variable not set")
        return {
            'statusCode': 500,
    ...
    try:
        ...
        data = json.dumps(release_request).encode('utf-8')
        ...
        # Send the request to release inventory
